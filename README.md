...
Plotting heart rate over time displays a wave profile. Increasing the amplitude of this wave, is increasing HRV and thus calm. CalmCoach uses PPG data to determine the amplitude of this wave profile and provides real-time feedback enabling the user to adjust breathing to maximize this amplitude.

![HR Max Min](Images/Heart_Rate_Max_Min.png)
